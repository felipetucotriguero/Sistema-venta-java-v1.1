...
public final class Sistema extends javax.swing.JFrame {
    ...
    public void ListarConfig() {
        ...
        txtRucConfig.setText("" + conf.getDni_empresa());
    ...
    public double predecirSiguienteVenta(int limite) {
        ...
        return suma / ventas.size(); // promedio dinámico
    }
    ...
    private void initComponents() {
        ...
        jPanel15.setBorder(javax.swing.BorderFactory.createTitledBorder("Registro Fallas"));
        jPanel15.setEnabled(false);

        jLabel16.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel16.setText("Nombre Activo");
        ...
        btnEliminarCliente1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        TableCliente1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "NOMBRE ACTIVO", "INICIO FALLA", "FIN FALLA", "DESCRIPCION"
            }
        ));
        ...
        jScrollPane7.setViewportView(TableCliente1);
        ...
        getContentPane().add(BtnCerrarSesion, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 60, -1, -1));
    ...
    private void btnActualizarConfigActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarConfigActionPerformed
        ...
        if (!"".equals(txtRucConfig.getText()) || !"".equals(txtNombreConfig.getText()) || !"".equals(txtTelefonoConfig.getText()) || !"".equals(txtDireccionConfig.getText())) {
            conf.setDni_empresa(txtRucConfig.getText());
    ...
    private void txtRucVentaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtRucVentaKeyTyped
        // TODO add your handling code here:
        event.numberKeyPress(evt, txtIdCV);
    ...
    private void btnEliminarventaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarventaActionPerformed
        ...
        int fila = TableVenta.getSelectedRow(); // obtiene la fila seleccionada
    ...
    private void jTxtPrediccionKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTxtPrediccionKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            if (!n.equals("")){
                ...
                LabelPrediccion.setText(String.valueOf(prediccion + " Bs."));
            }
            else {
                JOptionPane.showMessageDialog(null, 
...
// Simplemente llama al método estático
    ...
    private void TotalPagar() {
        ...
        LabelTotal.setText("Bs. "+String.format("%.2f", Totalpagar));
    }
