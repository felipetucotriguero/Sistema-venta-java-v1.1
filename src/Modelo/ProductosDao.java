...
public class ProductosDao {
    ...
    public Config BuscarDatos(){
        ...
        try {
            ...
            if (rs.next()) {
                ...
                conf.setDni_empresa(rs.getString("dni_empresa"));
    ...
    public boolean ModificarDatos(Config conf){
       String sql = "UPDATE config SET dni_empresa=?, nombre=?, telefono=?, direccion=?, mensaje=? WHERE id=?";
       try {
           ps = con.prepareStatement(sql);
           ps.setString(1, conf.getDni_empresa());
